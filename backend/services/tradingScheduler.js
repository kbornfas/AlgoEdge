 ...
 * 
 * NOTE: Kill switch has been DISABLED - always returns canTrade: true
 */
function checkKillSwitch(balance, equity, dailyStartBalance) {
  // Kill switch disabled - always allow trading
  return { canTrade: true, level: null, reason: 'Normal trading (kill switch disabled)', closeAll: false };
}
