...
const demoProviders: Record<string, ProviderDetails> = {
  '1': {
    ...
    description: 'Professional forex signals with proven track record. Our team of expert analysts combines technical analysis, fundamental insights, and AI-powered algorithms to deliver high-probability trade setups across major forex pairs and gold. With over 3 years of verified performance and 850+ pips monthly average, we help traders of all levels achieve consistent results.',
    bio: 'Official AlgoEdge signal provider with verified 3-year track record.',
    avatar_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face',
    trading_style: 'Scalping & Swing',
    risk_level: 'Medium',
    instruments: ['XAUUSD', 'EURUSD', 'GBPUSD', 'USDJPY', 'US30', 'NAS100'],
    performance_stats: {
      win_rate: 71,
      total_pips: 12500,
  ...
  '2': {
    ...
    description: 'Specialized in XAUUSD (Gold) trading with deep expertise in precious metals markets. Our signals focus on high-probability setups during London and New York sessions, combining order flow analysis with smart money concepts.',
    bio: 'XAUUSD specialist with 68% win rate.',
