...
// Demo signal provider data - Popular Instagram Forex Traders
const demoProviders: Record<string, ProviderDetails> = {
  '1': {
    id: 1,
    user_id: 1,
    name: 'HABBY FX',
    description: 'Top-tier forex educator & signal provider with millions of followers. Known for precise gold entries and consistent profitability. Our signals focus on high-probability setups during London and New York sessions, combining price action with smart money concepts.',
    bio: 'Top-tier forex educator & signal provider. Known for precise gold entries and consistent profitability.',
    ...
    performance_stats: {
      win_rate: 84.5,
      total_pips: 32500,
      avg_pips_per_trade: 75,
      total_signals: 2450,
      best_month_pips: 3850,
      worst_month_pips: 420,
    },
    pricing: {
      monthly: 99,
      quarterly: 249,
  ...
  '2': {
    ...
    user_id: 2,
    name: 'KOJO FX',
    description: 'Elite forex trader specializing in gold and indices. Consistent results with detailed analysis for every trade setup. Known for educational content and mentorship alongside premium signals.',
    bio: 'Elite forex trader specializing in gold and indices. Consistent results with detailed analysis.',
    avatar_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
    trading_style: 'Swing Trading',
    risk_level: 'Moderate',
    instruments: ['XAUUSD', 'GBPUSD', 'NAS100'],
    performance_stats: {
      win_rate: 81.2,
      total_pips: 28920,
      avg_pips_per_trade: 82,
      total_signals: 1820,
      best_month_pips: 3200,
      worst_month_pips: 280,
    },
    pricing: {
      monthly: 89,
      quarterly: 229,
  ...
  '3': {
    ...
    user_id: 3,
    name: 'AMIIN FX',
    description: 'Professional trader with years of experience in the forex market. Specializing in scalping and intraday setups on gold and major pairs. Fast execution signals with tight stop losses for maximum efficiency.',
  ...
  '4': {
    ...
    user_id: 4,
    name: 'VIDOLLAR',
    description: 'Master of price action trading with a massive following. Known for catching big moves in forex and crypto markets with pinpoint accuracy. Combines technical mastery with market psychology for consistent wins.',
    bio: 'Master of price action trading. Known for catching big moves with pinpoint accuracy.',
    avatar_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face',
    trading_style: 'Day Trading',
    risk_level: 'Moderate',
    instruments: ['XAUUSD', 'BTCUSD', 'NAS100'],
    performance_stats: {
      win_rate: 82.8,
      total_pips: 35340,
      avg_pips_per_trade: 88,
      total_signals: 1650,
      best_month_pips: 4100,
      worst_month_pips: 320,
    },
    pricing: {
      monthly: 99,
      quarterly: 259,
          ...
          <Grid item xs={12} md={8}>
            ...
            <Box sx={{ display: 'flex', gap: 3, mb: 4 }}>
              <Box sx={{ position: 'relative' }}>
                ...
                {(provider.has_blue_badge || provider.is_verified) && (
                  <Box
                    sx={{
                      position: 'absolute',
                      bottom: 0,
              ...
              <Box sx={{ flex: 1 }}>
                <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
                  ...
                  {(provider.has_blue_badge || provider.is_verified) && <BlueBadge size={20} />}
                </Stack>
