...
const menuCategories = [
  {
    ...
    items: [
      ...
      { text: 'Trading Journal', icon: BookOpen, href: '/dashboard/journal', requiresSubscription: true },
      { text: 'Signal Leaderboard', icon: TrendingUp, href: '/dashboard/leaderboard', requiresSubscription: true },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Trading Glossary', icon: BookOpen, href: '/dashboard/glossary', requiresSubscription: true },
      { text: 'Knowledge Base', icon: HelpCircle, href: '/dashboard/knowledge-base', requiresSubscription: true },
      { text: 'Market News', icon: Newspaper, href: '/dashboard/news', requiresSubscription: true },
      { text: 'Social Feed', icon: MessageSquare, href: '/dashboard/social', requiresSubscription: true },
      { text: 'Community', icon: MessageSquare, href: '/dashboard/community', requiresSubscription: true },
      { text: 'Competitions', icon: Trophy, href: '/dashboard/competitions', requiresSubscription: true },
    ],
  },
  {
    title: 'Account',
